          ...
          <div id='navbarSupportedContent' className='collapse navbar-collapse'>
            <ul className='navbar-nav ml-auto'>
               ...
               <li className="dropdown nav-item">
                <a href="javascript:;" className="dropdown-toggle nav-link font-weight-bold" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
              ...
              <li className="dropdown nav-item">
                <a href="javascript:;" className="dropdown-toggle nav-link font-weight-bold" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">NFT<span className="caret"></span>
                </a>
                <ul className="dropdown-menu">
                  <li>
              ...
              <li className="dropdown nav-item">
                ...
                <li className="dropdown nav-item">
                <a href="javascript:;" className="dropdown-toggle nav-link font-weight-bold" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Docs<span className="caret"></span>
                </a>
                <ul className="dropdown-menu">
                  <li>
